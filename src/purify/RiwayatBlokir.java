...
public class RiwayatBlokir {
    ...
    public IntegerProperty nomorProperty() { return new SimpleIntegerProperty(nomor); }
    public StringProperty tanggalMulaiProperty() { return new SimpleStringProperty(tanggalMulai); }
    public IntegerProperty durasiProperty() { return new SimpleIntegerProperty(durasi); }
    public StringProperty statusProperty() { return new SimpleStringProperty(status); }
    public StringProperty aktivitasProperty() { return new SimpleStringProperty(aktivitas); }
}